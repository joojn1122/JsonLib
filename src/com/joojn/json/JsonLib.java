...
//    }
    ...
    public static String getStringMultiplier(String str, int multiplier)
    {
        String builder = IntStream.range(0, multiplier).mapToObj(i -> str).collect(Collectors.joining());
    ...
    private static JsonObject parseObject(String str)
    {
        ...
        for(char c : str.toCharArray())
        {
            ...
            else if(nested.writing)
            {
                ...
                else if(c == nested.closeBracket && !nested.inQuotes)
                {
                    ...
                    if(nested.brackets == 0)
                    {
                        ...
                        dict.setElement(key, nested.func.call(nested.text));
            ...
            else if(c == '}')
            {
                if(key.length() != 0)
                {
                    dict.setElement(key, getJsonElementFromString(value));
                }
